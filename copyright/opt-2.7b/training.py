...
class LLMTolkien():
    ...
    def train(
        ...
        model.save_pretrained("/scratch/aa10350/llm-finetune/llm-finetune-copyright/models/finetune_2.7b")
        tokenizer.save_pretrained("/scratch/aa10350/llm-finetune/llm-finetune-copyright/models/finetune_2.7b_token")
