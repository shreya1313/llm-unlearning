...
#         dataset = load_dataset(hf_repo)
        ...
        model.save_pretrained("/scratch/sa6981/llm_unlearn/finetune_copyright/models/finetune_1.3b")
        tokenizer.save_pretrained("/scratch/sa6981/llm_unlearn/finetune_copyright/models/finetune_1.3b_token")
