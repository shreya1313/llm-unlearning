...
logging.basicConfig(filename='/scratch/sg7729/machine-unlearning/logs/evaluate_1_test.log', level=logging.DEBUG)
...
original_model_path = 'facebook/opt-1.3b'
...
for bad_batch in zip(test_bad_loader):
    ...
    bad_outputs = generator(processed_prompt, max_length=100)
